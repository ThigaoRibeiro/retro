...
///////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public function bootstrap($clie_id, string $rua, string $numero = null, string $complemento = null, string $bairro, string $cidade, string $cep, string $referencia = null, string $telefone):?UserAddress
    {
...
/////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public function save(): ?UserAddress
    {
        ...
        if (!empty($this->clie_id)) {
            $userId = $this->clie_id;
            $telefone = $this->read("SELECT clie_id FROM clie_endereco WHERE telefone = :telefone AND clie_id != :clie_id",
                "telefone={$this->telefone}&clie_id={$userId}");
        ...
        $this->data = $this->read("SELECT * FROM clie_endereco WHERE endereco_id = :endereco_id" , "endereco_id={$userId}")->fetch();
        return $this;
